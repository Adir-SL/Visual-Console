...
function addConsole(){
    ...
    LinkStyles("#vconsole_"+window.checkTime+" .tabClass{ filter:none; background-color:#ffffff; color:#999999; font-weight:normal; padding: 0 4px; border-bottom:none; flex-grow:1; margin-right:8px;cursor:pointer; }"+"#vconsole_"+window.checkTime+" .tabClass:hover{ opacity:.8; }")

    //Links Select CSS
    const LinkSStyles = s =>(d=>{d.head.appendChild(d.createElement("style")).innerHTML=s})(document);
    LinkSStyles("#vconsole_"+window.checkTime+" .tabSelect{ color:#333333; font-weight:bold; border-bottom:2px solid; }")
