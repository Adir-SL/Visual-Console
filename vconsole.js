...
function addConsole(){
    ...
    document.body.innerHTML += "<div id='velements_"+window.checkTime+"' class='vConUndetect'><div style='display:flex;position:sticky;top:0;background-color:#ffffff;border-radius:0;'><a class='tabClass' onclick='vconConsoleFunc();'>Console</a><a class='tabClass tabSelect' onclick='vconElemFunc();'>Elements</a></div><div>Coming Soon...</div></div><div id='vconsole_"+window.checkTime+"' class='vConUndetect'><div style='display:flex;position:sticky;top:0;background-color:#ffffff;border-radius:0;'><a class='tabClass tabSelect' onclick='vconConsoleFunc();'>Console</a><a class='tabClass' onclick='vconElemFunc();'>Elements</a></div><details class='vConUndetect' open><summary class='vConUndetect'></summary></details></div><div class='flexDiv vConUndetect' id='flex_"+window.checkTime+"'><input class='vConUndetect' spellcheck='false' autocapitalize='none' list='historyList' placeholder='Type code here...'></input><datalist id='historyList' class='vConUndetect'></datalist><button id=ibutton_"+window.checkTime+" class='vConUndetect' onclick='iFunc(event);' title='Run code (Enter)'>"+window.chevSvgIcon+"</button><button id=pbutton_"+window.checkTime+" class='vConUndetect' onclick='selectFromPage();' title='Select an element from the page (Ctrl+H)'>"+window.pickSvgIcon+"</button></div><button id='vbutton_"+window.checkTime+"' class='vConUndetect' onclick='toggleConsole();' title='Toggle this panel (~)'>"+window.chevSvgIcon+"</button>";

    //Console CSS
    const ConsoleStyles = s =>(d=>{d.head.appendChild(d.createElement("style")).innerHTML=s})(document);
    ConsoleStyles("#vconsole_"+window.checkTime+"{ position:fixed; font-weight:normal; right:16px; top:16px; width:300px; max-width:50%; height:150px; padding:8px; padding-top:0; overflow:auto; scroll-behavior:smooth; background-color:#ffffff; box-shadow:0 4px 16px 0 rgba(0,0,0,.2); font-family:monospace; border-radius: 8px;transform-origin:center;transition:transform 100ms ease-in-out, opacity 100ms ease-in-out; }"+"#velements_"+window.checkTime+" div{ margin-bottom:4px; padding:8px;}"+"#vconsole_"+window.checkTime+" div{ margin-bottom:4px; padding:8px; border-radius:4px; color:#000000; background-color:#ededed; }"+"#vconsole_"+window.checkTime+" summary:empty ~ div:last-of-type{ animation:slideOver 200ms ease-out; }"+window.checkTime+" summary:empty{ height:0; }"+"#vbutton_"+window.checkTime+"{ position:fixed; right:32px; top:32px; padding:1px; margin:0; opacity:1; width:32px; height:32px; border:none; transform:translate(80%,-80%); outline:none; background-color:skyblue; color:#ffffff; font-weight:bold; border-radius:50%; display: flex; align-items: center; justify-content: center; cursor:pointer; box-shadow:0 4px 8px 0 rgba(0,0,0,.2); } @keyframes slideOver{ 0%{transform: translateX(-100%);} 100%{transform: translateX(0px);}}"+"#vconsole_"+window.checkTime+" + .flexDiv{ display:flex; align-items:stretch; position:fixed; top:180px; right:16px; width: 300px; padding: 8px; margin-top: 8px; border-radius:8px; box-shadow:0 4px 16px 0 rgba(0,0,0,.2); background-color:#ffffff;transition:opacity 100ms ease-in-out; }"+"#vconsole_"+window.checkTime+" + .flexDiv input{ width:calc(100% - 64px); background-color:#ffffff; border-radius:4px; padding: 8px; border:1px solid #cccccc; outline:none;margin-right:4px; font-size: 16px; -webkit-appearance: none; -moz-appearance: none; appearance: none; }"+"#ibutton_"+window.checkTime+"{ border-radius:4px; border:none; box-shadow:0 0 0 2px skyblue inset; outline:none; background-color:#ffffff; color:#ffffff; padding:1px; margin:0; opacity:1; width:36px; font-weight:bold; display: flex; align-items: center; justify-content: center; cursor:pointer; }"+"#pbutton_"+window.checkTime+"{ border-radius:4px; border:none; outline:none; background-color:#ffffff; color:grey; padding:1px; margin:0; opacity:1; width:36px; font-weight:bold; display: flex; align-items: center; justify-content: center; cursor:pointer;margin-right: 4px; }"+"#vbutton_"+window.checkTime+" svg{ transition:transform 200ms ease-in-out; }"+"#ibutton_"+window.checkTime+" svg{ transform:rotate(-90deg); }"+"#ibutton_"+window.checkTime+" path{ fill:skyblue; }"+"#ibutton_"+window.checkTime+":active, #ibutton_"+window.checkTime+":focus, #vbutton_"+window.checkTime+":active, #vbutton_"+window.checkTime+":focus{ box-shadow: 0 0 0 2px cornflowerblue inset, 0 4px 8px 0 rgba(0,0,0,.2); }"+"#ibutton_"+window.checkTime+":hover, #vbutton_"+window.checkTime+":hover{ filter:brightness(104%); }"+"#pbutton_"+window.checkTime+":hover{ filter:brightness(115%); }"+"#ibutton_"+window.checkTime+":focus path, #vbutton_"+window.checkTime+":focus path{ fill:cornflowerblue; }"+"#pbutton_"+window.checkTime+":focus{ color:#ffffff; background-color:grey; }"+"#vbutton_"+window.checkTime+" svg, #ibutton_"+window.checkTime+" svg, #pbutton_"+window.checkTime+" svg{ pointer-events:none; }")
    ...
    ElementsStyles("#velements_"+window.checkTime+"{ position:fixed; font-weight:normal; right:16px; top:16px; width:300px; max-width:50%; height:150px; padding:8px; padding-top:0; overflow:auto; scroll-behavior:smooth; background-color:#ffffff; box-shadow:0 4px 16px 0 rgba(0,0,0,.2); font-family:monospace; border-radius: 8px;transform-origin:center;transform:translateX(-100%); opacity:0; pointer-events:none; transition:transform 100ms ease-in-out, opacity 100ms ease-in-out; }")
...
function vconElemFunc(){
    document.getElementById("velements_"+window.checkTime).style.transform = "translateX(0)";
    ...
    document.getElementById("vconsole_"+window.checkTime).style.transform = "translateX(100%)";
    document.getElementById("vconsole_"+window.checkTime).style.opacity = 0;
    document.getElementById("vconsole_"+window.checkTime).style.pointerEvents = "none";
}
function vconConsoleFunc(){
    document.getElementById("velements_"+window.checkTime).style.transform = "translateX(-100%)";
    ...
    document.getElementById("vconsole_"+window.checkTime).style.transform = "translateX(0)";
    document.getElementById("vconsole_"+window.checkTime).style.opacity = 1;
    document.getElementById("vconsole_"+window.checkTime).style.pointerEvents = "all";
}
